...
import RepaireTableRow from './RepaireReportTableRow';
...
export default  class RepairReport extends  Component{
    ...
    onSubmitgetDetails(e) {
        ...
        axios.get('http://localhost:4000/repair/getReportData/'+this.state.id)
    ...
    render() {
        return(
            <div>
                <br/>
                <h3 style={{textAlign:'center'}}>Enter your filter for genarate report..</h3>
